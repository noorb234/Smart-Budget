...
<main id="loginSection">
    <div class="login-form">
		...
		if ($fail == "")
		  {
			...
			echo "<label><br><br>Your account has been successfully created.<br><br>Please <a href='login.php'>click here</a> to signin.</label>";
			exit;
		  }
		...
		function validate_email($pdo, $em)
		  {
			...
			if ($em == ""){
				...
				return "This email is already registered with an account.<br>";
			}
			return "";
		  }
		...
		function validate_security_questions($sq1, $sq2){
			if ($sq1 == ""){
				return "No security question 1 was entered.<br>";
			}
			else if ($sq2 == ""){
				return "No security question 2 was entered.<br>";
			}
		}
		...
		function validate_security_answers($sa1, $sa2){
			if ($sa1 == ""){
				return "No security answer 1 was entered.<br>";
			}
			else if ($sa2 == ""){
				return "No security answer 2 was entered.<br>";
			}
		}
